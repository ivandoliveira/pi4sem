...
A collection abaixo contém a rota enviada por você:
**Consultar pedidos de um usuário pelo ID do cliente**

### 📄 Arquivo JSON da Collection

Você pode copiar o conteúdo abaixo para um arquivo chamado:

```
insomnia-collection.json
```

### ✔️ Collection com a rota enviada
...
```json
{
  "resources": [
    {
      "type": "request",
      "name": "Consultar Pedido por ID de Cliente",
      "method": "GET",
...
```
Perfeito! Podemos criar um **README.md** bem organizado para o seu projeto, incluindo:

* Nome dos integrantes do grupo
* Como subir o XAMPP local
* Endpoints da API (com a collection do Insomnia)

Segue uma sugestão completa:
...
3. Inicie os módulos:
   ...
   * **Apache**
   * **MySQL**
4. Coloque o projeto na pasta `htdocs` do XAMPP (ex: `C:\xampp\htdocs\ecommerce_api`).
5. Acesse no navegador: `http://localhost/ecommerce_api/`.

> Certifique-se de que a porta 80 (Apache) e 3306 (MySQL) estão livres.

---

## Collection do Insomnia

Você pode importar a collection abaixo diretamente no **Insomnia** para testar a API local.
